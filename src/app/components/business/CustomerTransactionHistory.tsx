      ...
      <header className="sticky top-0 z-20 bg-white border-b border-gray-200 shadow-sm">
        <div className="flex items-center gap-3 p-4">
          ...
          <div className="flex-1 min-w-0">
            <h1 className="text-lg font-black text-gray-900 truncate">كشف حساب</h1>
        ...
        <div className="p-4 space-y-3">
          ...
          <div className="grid grid-cols-3 gap-2">
            <Card className="p-2.5 bg-gradient-to-br from-emerald-50 to-emerald-100/50 border border-emerald-200/50 rounded-xl">
              ...
              <div className="text-[9px] text-emerald-600 mt-0.5">{getCurrencySymbol(customer.currency)}</div>
            </Card>
            <Card className="p-2.5 bg-gradient-to-br from-red-50 to-red-100/50 border border-red-200/50 rounded-xl">
              ...
              <div className="text-[9px] text-red-600 mt-0.5">{getCurrencySymbol(customer.currency)}</div>
            </Card>
            <Card className="p-2.5 bg-gradient-to-br from-gray-50 to-gray-100/50 border border-gray-200/50 rounded-xl">
              ...
              <div className="text-[9px] text-gray-600 mt-0.5">{getCurrencySymbol(customer.currency)}</div>
            </Card>
          </div>
          ...
          <Card className="p-3 bg-gradient-to-br from-gray-50 to-gray-100/50 border border-gray-200 rounded-xl">
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="text-right">
                ...
                <div className="text-base font-black text-emerald-600">{customer.balance} {getCurrencySymbol(customer.currency)}</div>
              </div>
            </div>
          </Card>
        </div>
